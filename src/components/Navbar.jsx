...
const Navbar = () => {
  ...
  const linkCls = (active) =>
    `text-sm font-medium transition-colors px-3 py-1.5 rounded-md ${
      active ? "text-[#1a4731] bg-[#e8f0eb]" : "text-gray-600 hover:text-[#1a4731] hover:bg-gray-50"
    }`;

  return (
    <nav className="bg-white border-b border-[#e2ddd5] sticky top-0 z-50">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-2.5 group">
            ...
            <div className="leading-none">
              <span className="text-[#1a4731] font-bold text-lg block leading-tight">উত্তরাধিকার</span>
              <span className="text-[#c9a84c] text-[9px] tracking-[0.18em] uppercase font-medium">ফারায়েজ ক্যালকুলেটর</span>
            </div>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            >
              <button className={`${linkCls(isEduActive)} flex items-center gap-1`}>
                শিক্ষামূলক
                <FaChevronDown size={10} className={`transition-transform ${eduOpen ? "rotate-180" : ""}`} />
              </button>
              {eduOpen && (
          ...
          <button
            ...
            className="md:hidden p-2 rounded-md hover:bg-gray-50 text-gray-600"
          >
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="md:hidden bg-white border-t border-[#e2ddd5] py-2">
          <div className="max-w-7xl mx-auto px-4 space-y-0.5">
            ...
            <div className="pt-2 pb-1">
              <p className="text-[10px] font-semibold text-gray-400 uppercase tracking-wider px-3 mb-1">শিক্ষামূলক</p>
              {eduLinks.map(l => (
