...
const Navbar = () => {
  ...
  const activeLinkStyle = ({ isActive }) => 
    `relative py-2 px-1 text-base font-bold transition-all duration-300 flex flex-col items-center group
  ...
  return (
    <nav className="bg-[#064e3b] text-white shadow-2xl sticky top-0 z-50 border-b border-white/5 backdrop-blur-md">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            ...
            <div className="flex flex-col py-1"> {/* ই-কারের জন্য এক্সট্রা প্যাডিং */}
          ...
          {/* ডেস্কটপ মেনু (হিসাব করুন বাটন সরিয়ে দেওয়া হয়েছে) */}
      ...
      {/* মোবাইল ড্রপডাউন */}
      <div className={`md:hidden absolute w-full bg-emerald-900 border-t border-white/5 transition-all duration-300 ${isOpen ? 'max-h-64 opacity-100' : 'max-h-0 opacity-0 overflow-hidden'}`}>
